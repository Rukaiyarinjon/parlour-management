...
<div>
  <img src="myimage/image1.jpg" alt="">
</div>
                    ...
                    <div class="grids-content row">
                        ...
                        <div class="column col-lg-4 col-md-6 color-2 ">
                         ...
                         <div class="column col-lg-4 col-md-6 col-sm-6 back-image  ">
                            <img src="assets/images/5.jpg" alt="product" class="img-responsive img-fluid">
                        </div>
                        <div class="column col-lg-4 col-md-6 col-sm-6 back-image2 ">
                            <img src="assets/images/6.jpg" alt="product" class="img-responsive img-fluid">
                          </div> 
                    </div>
                </div>
        </div>
        ...
        <div class="container">
            <div class=" row">
                <div class="col-lg-6 back-image">
                    <img src="assets/images/b1.jpg" alt="product" class="img-responsive img-fluid">
                </div>
